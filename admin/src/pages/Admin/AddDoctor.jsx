...
const AddDoctor = () => {
  ...
  return (
    <form
      ...
      className="px-3 md:m-5 w-full overflow-hidden"
    >
      <p className="mb-3 text-lg font-medium">Add Doctor</p>
      <div className="bg-white px-3 md:px-8 py-8 border rounded w-full max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-4 md:gap-10 text-gray-600">
